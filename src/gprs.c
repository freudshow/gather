...
/*
******************************************************************************
* º¯ÊýÃû³Æ£º uint8 Gprs_DataSend(uint8 *Data,uint32 n)
* Ëµ	Ã÷£º GPRS½Ó¿Ú·¢ËÍÊý¾Ý¡£
* ²Î	Êý£º 
******************************************************************************
*/
uint8 Gprs_DataSend(uint8 *Data,uint32 n)
{
	...
	lu32delaytimes = lu32delaytimes*n;  //¼ÆËã³öÔÚËÙÂÊÎªRS485UP_COM_SPEEDÊ±£¬·¢ËÍn¸ö×Ö½Ú´ó¸ÅÐèÒªÊ±¼ä¡£

	usleep(lu32delaytimes); //±£Ö¤±¾´ÎÊý¾Ý·¢Íê¡£
